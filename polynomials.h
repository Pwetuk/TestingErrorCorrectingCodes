...
polynomial
add_two_polynomials(struct field*, polynomial, polynomial);

polynomial
multiply_two_polynomials(struct field*, polynomial, polynomial);
...
struct extended_polynomial*
add_two_extended_polynomials(struct field*, struct extended_polynomial*, struct extended_polynomial*);

struct extended_polynomial*
multiplty_two_extended_polynomials(struct field*, struct extended_polynomial*, struct extended_polynomial*);
